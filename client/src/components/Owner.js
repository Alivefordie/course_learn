...
const CourseComponent = () => {
  ...
  const fetchOwnerCourses = async () => {
    try {
      const response = await ax.get("http://localhost:1337/api/course");
        ...
        <Card key={course.id} className="d-flex flex-row">
          ...
          >
            <Card.Img
              ...
              variant="left"
              src={"http://localhost:1337" + course.picture}
            />
          </div>
          <div className="body-col">
            ...
            >
              ...
              <Card.Text className="m-0">
                เนื้อหา {course.courseContent.description}
              </Card.Text>
              <Card.Text className="m-0">
                ระยะเวลา {course.courseContent.duration}
              </Card.Text>
              <Card.Text className="m-0">
                ครู {course.teacher.username}
              </Card.Text>
            </Card.Body>
          </div>
        </Card>
